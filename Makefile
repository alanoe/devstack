...
.PHONY: analytics-pipeline-devstack-test analytics-pipeline-shell \
        ...
        e2e-tests ecommerce-shell feature-toggle-state healthchecks help \
        ...
        xqueue_consumer-shell xqueue-shell
...
dev.onlypull.%: ## Pull latest Docker images for services (separated by plus-signs).
...
pull.xqueue: dev.onlypull.xqueue+xqueue_consumer
